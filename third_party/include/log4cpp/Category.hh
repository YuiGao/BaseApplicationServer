...
namespace log4cpp {
    ...
    class LOG4CPP_EXPORT Category {
        ...
        */       
        ...
        /** 
         * Log a message with \ priority.
         * @param stringFormat Format specifier for the string to write 
         * in the log file.
         * @param ... The arguments for stringFormat 
         **/  
        void debug(const char* stringFormat, ...) throw();
		void debug_1(const char* info,const char* stringFormat, ...) throw();
        /** 
         * Log a message with debug priority.
         * @param message string to write in the log file
         **/  
        void debug(const std::string& message) throw();
        void debug_1(const std::string& info,const std::string& message) throw();
        ...
        void info_1(const std::string& info,const std::string& message) throw();
        ...
        void warn_1(const std::string& info,const std::string& message) throw();
        ...
        void error_1(const std::string& info,const std::string& message) throw();
